...
function get_designation(thisTxt) {
    ...
    $.ajax({
        type: 'GET',
        url: "get-specific-designation-master/" + $(thisTxt).attr('designationID'),
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if(response['response'] == 'success'){
                ...
                alert('An Error occured while storing designation Info. Please try again!');
                return false;
            }
        }
    });
...
function edit_designation(thisTxt){
    ...
    $.ajax({
        type: 'POST',
        url: "designation-master-edit/" + $(thisTxt).attr('designation_masterID'),
        headers: { 'X-CSRFToken': csrftoken },
        data: {'designationText':designation_name},
        success: function (response) {
            console.log(response['response']);
            if(response['response'] == 'success'){
                ...
                alert('An Error occured while updating designation Info. Please try again!');
                return false;
            }
        }
    });
...
function delete_designation(thisTxt){
    if (confirm('Are you sure you want to delete this task?')) {
        ...
        $.ajax({
            type: 'GET',
            url: "designation-master-delete/"+$(thisTxt).attr('designationID'),
            success: function (response) {
                console.log(response['response']);
                ...
                if(response['response'] == 'success'){
                    ...
                    alert('Employee with this designation exist. Cannot delete this designation!');
                    // window.location.reload()
                }else{
                    alert('You are not authorized to delete this designation!');
                    return false;
                }
            }
        });
