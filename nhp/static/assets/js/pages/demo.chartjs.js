            ...
            return (
                0 < d("#line-chart-example").length &&
                    ((a = {
                        ...
                        datasets: [
                            { label: "Current Week", backgroundColor: hexToRGB((n = (o = d("#line-chart-example").data("colors")) ? o.split(",") : i.concat())[0], 0.3), borderColor: n[0], data: [32, 42, 42, 62, 52, 75, 62] },
                ...
                0 < d("#bar-chart-example").length &&
                    ...
                    (t = {
                        ...
                        datasets: [
                            { label: ["Performance"], backgroundColor: r, borderColor: r, hoverBackgroundColor: r, hoverBorderColor: r, data: [65, 59, 80, 81, 56, 89, 40, 32, 65, 59, 80, 81], },
                        ],
                ...
                0 < d("#donut-chart-example").length &&
                    ((e = {
                        ...
                        datasets: [{ data: [300, 135, 48, 154], backgroundColor: (n = (o = d("#donut-chart-example").data("colors")) ? o.split(",") : i.concat()), borderColor: "transparent", borderWidth: "3" }],
                    }),
                    l.push(this.respChart(d("#donut-chart-example"), "Doughnut", e, { maintainAspectRatio: !1, cutoutPercentage: 60, legend: { display: !1 } }))),
